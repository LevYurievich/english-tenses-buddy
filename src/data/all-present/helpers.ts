/**
 * Конструкторы смешанных упражнений (модуль «Все Present»).
 * Помогают компактно описывать задания вместе с объяснением «Почему?».
 * Структура универсальная: тот же файл подойдёт для будущих модулей Past и Future.
 */
import type {
  ErrorCategory,
  Exercise,
...
export const ALL_PRESENT_ID = "all-present";

/**
 * «Все Future»: 55 смешанных тренировочных заданий (20 / 20 / 15) и банк Future Challenge (24).
...
export const FUTURE_LEVEL_1: Exercise[] = [
  ...
  MC({ id: "af1-6", level: 1, t: FC, q: "At 8 p.m. tomorrow I ___ the match.", v: ["watch", "watching", "watched"], when: "AT 8 p.m. tomorrow — точка в будущем.", what: "Что будет происходить В этот момент — процесс." }),
  ...
  MC({ id: "af1-9", level: 1, t: FC, q: "Don't call me at 7 — I ___ dinner then.", v: ["have", "having", "had"], when: "AT 7 — момент.", what: "В 7 будет идти ужин — процесс." }),
  ...
  MC({ id: "af1-11", level: 1, t: FP, q: "By Friday I ___ the project.", v: ["finish", "finishing", "finished"], when: "BY Friday — к моменту.", what: "Проект будет готов — результат." }),
  ...
  MC({ id: "af1-16", level: 1, t: FPC, q: "By 6 p.m. I ___ for ten hours.", v: ["work", "working", "worked"], when: "BY 6 p.m. + for ten hours.", what: "Как долго процесс будет идти к этому моменту." }),
...
export const FUTURE_LEVEL_2: Exercise[] = [
  ...
  MC({ id: "af2-4", level: 2, t: FS, q: "In the future, robots ___ most boring jobs.", v: ["do", "doing", "done"], when: "Будущее вообще, без точки.", what: "Прогноз." }),
  ...
  FB({ id: "af2-7", level: 2, t: FC, q: "When your plane lands, I ___ (wait) for you at the exit.", v: ["wait", "waiting", "waited"], when: "Момент — самолёт приземлится.", what: "Я уже буду в процессе ожидания." }),
  MC({ id: "af2-8", level: 2, t: FC, q: "Call me after 9. Before that I ___ my little brother to bed.", v: ["put", "putting", "put"], when: "До 9 — занятое время.", what: "Процесс, который будет идти." }),
  ...
  MC({ id: "af2-14", level: 2, t: FP, q: "Anna saves 10 euros a week. In a year she ___ enough for a new phone.", v: ["save", "saving", "saved"], situation: "Через год нужная сумма уже будет накоплена.", when: "Через год = к этому моменту.", what: "Результат — накопленная сумма." }),
  FB({ id: "af2-15", level: 2, t: FP, q: "The party starts at 6, but by 5 we ___ (decorate) the whole room.", v: ["decorate", "decorating", "decorated"], when: "By 5.", what: "Комната будет украшена — результат." }),
  ...
  FB({ id: "af2-17", level: 2, t: FPC, q: "Mark started his game at 3. By 6 he ___ (play) for three hours.", v: ["play", "playing", "played"], when: "By 6.", what: "Длительность игры к этому моменту." }),
  MC({ id: "af2-18", level: 2, t: FPC, q: "Grandpa started repairing the car in the morning. By dinner time he ___ on it all day.", v: ["work", "working", "worked"], when: "By dinner time.", what: "Процесс длится весь день." }),
...
export const FUTURE_LEVEL_3: Exercise[] = [
  ...
  FB({ id: "af3-4", level: 3, t: FS, q: "Don't lift that box — I ___ (carry) it for you.", v: ["carry", "carrying", "carried"], when: "Решение прямо сейчас.", what: "Предложение помощи." }),
  ...
  FB({ id: "af3-7", level: 3, t: FC, q: "Don't phone Lisa at 8 — she ___ (do) her yoga.", v: ["do", "doing", "done"], when: "At 8.", what: "Йога будет в процессе." }),
  ...
  FB({ id: "af3-11", level: 3, t: FP, q: "By the time the lesson starts, the teacher ___ (check) all our tests.", v: ["check", "checking", "checked"], when: "By the time the lesson starts.", what: "Проверка будет закончена." }),
...
export const FUTURE_FINAL_BANK: Exercise[] = [
  ...
  MC({ id: "afx-7", level: 3, t: FC, q: "At midday tomorrow the plane ___ over the Alps.", v: ["fly", "flying", "flown"], when: "At midday tomorrow.", what: "Процесс полёта в момент." }),
  ...
  MC({ id: "afx-19", level: 3, t: FPC, q: "By 4 p.m. the girls ___ tennis for two hours.", v: ["play", "playing", "played"], when: "By 4 p.m. + for two hours.", what: "Длительность к моменту." }),

  MC({ id: "afx-2", level: 3, t: FS, q: "I'm sure our team ___ the next match.", v: ["win", "winning", "won"], when: "I'm sure.", what: "Прогноз." }),
  FB({ id: "afx-8", level: 3, t: FC, q: "Don't come at 6 — we ___ (cook) dinner then.", v: ["cook", "cooking", "cooked"], when: "At 6.", what: "Готовка в процессе." }),

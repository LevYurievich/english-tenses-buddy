...
export const LEVEL_2: CoordItem[] = [
  ...
  c(2, 15, "past-perfect-continuous", "Tom was out of breath because he ___ for twenty minutes.", "run", "had been running", "Задыхался в прошлом.", "for twenty minutes — процесс длился до этой точки и объясняет состояние."),
...
export const LEVEL_3: CoordItem[] = [
  ...
  c(3, 15, "past-perfect-continuous", "Her eyes were red because she ___ for an hour.", "cry", "had been crying", "Глаза были красными — прошлое.", "for an hour — процесс длился до точки и объясняет состояние."),

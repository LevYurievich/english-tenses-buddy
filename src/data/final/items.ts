...
type Extra = { context?: string[]; also?: string[]; variants?: { answers: string[]; note: string }[] };
...
export const FINAL_NEW: FinalQuestion[] = [
  ...
  { id: "fn-2", kind: "write", isNew: true, items: [f("2", "future-continuous", "— Better not. He ___ his English lesson then.", "have", "will be having", "8 вечера сегодня — момент в будущем.", "В этот момент урок будет идти — процесс в момент.", { context: ["— Can I call Tom at 8 tonight?"] })] },
  ...
  { id: "fn-7", kind: "write", isNew: true, items: [f("7", "past-continuous", "He ___ a book and didn't notice me.", "read", "was reading", "Я видел его утром — момент в прошлом.", "В тот момент чтение шло — процесс, поэтому он меня не заметил.", { context: ["I saw Tom at the bus stop this morning."] })] },
